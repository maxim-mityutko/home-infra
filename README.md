...
| Project       | Description                                                                                                                       | Docs / Repo                                                                               | Docker / Helm                                                                                                                              |
|---------------|-----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| **Filebrowser Quantum** | FileBrowser Quantum provides an easy way to access and manage your files from the web | [repo](https://github.com/gtsteffaniak/filebrowser)<br>[docs](https://github.com/gtsteffaniak/filebrowser/wiki) | [docker](https://github.com/gtsteffaniak/filebrowser/pkgs/container/filebrowser) |
...
| **Calibre-Web-Automated** | Calibre-Web but automated and with Calibre features! Fully automate and simplify your eBook set up! | [repo](https://github.com/crocodilestick/Calibre-Web-Automated) | [docker](https://hub.docker.com/r/crocodilestick/calibre-web-automated) |
| | **Calibre-Web-Automated-Book-Downloader** - An intuitive web interface for searching and requesting books, designed to work seamlessly with Calibre-Web-Automated | [repo](https://github.com/calibrain/calibre-web-automated-book-downloader) | [docker](https://github.com/calibrain/calibre-web-automated-book-downloader/pkgs/container/calibre-web-automated-book-downloader)
