...
| | **Plugin: Barman Cloud** - Barman Cloud [CNPG-I](https://github.com/cloudnative-pg/cnpg-i) backup plugin | [repo](https://github.com/cloudnative-pg/plugin-barman-cloud)<br>[docs](https://cloudnative-pg.io/plugin-barman-cloud/) | [helm](https://github.com/cloudnative-pg/charts/tree/main/charts/plugin-barman-cloud) |
