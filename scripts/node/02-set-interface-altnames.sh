...
#
# Usage:
#   sudo bash ./scripts/node/02-set-interface-altnames.sh
#   sudo bash ./scripts/node/02-set-interface-altnames.sh --subnet 192.168.42.0/25
#   sudo bash ./scripts/node/02-set-interface-altnames.sh --confirm --subnet 192.168.42.0/25
#
# Exit behavior:
